...
test('Next owns one projection and one unsaved setter without server or navigation authority', () => {
	...
	assert.match(activityStripSource, /webmcp-activity-outcome[\s\S]*?webmcp-activity-evidence[\s\S]*?webmcp-activity-authority[\s\S]*?WebMCP · \{toolName\}/u);
